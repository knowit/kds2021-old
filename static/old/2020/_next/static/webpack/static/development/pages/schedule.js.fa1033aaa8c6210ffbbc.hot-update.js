...
var Schedule = function Schedule() {
  ...
  var filterProgram = function filterProgram() {
    ...
    var newDays = []; // TODO - Manually filter rooms

    newProgram.days.forEach(function (day) {
      var newSlots = [];
      day.slots.forEach(function (slot) {
        slot.rooms.forEach(function (room) {
          var newRooms = room.talks.filter(function (talk) {
            var tags = talk.tags.concat([talk.language]);

            if (showOnlyFavorites && !localStorage.getItem(talk.talkId)) {
              return false;
            } else {
              return !(tags.length > 0 && !tags.some(function (tag) {
...
//# sourceMappingURL=schedule.js.fa1033aaa8c6210ffbbc.hot-update.js.map